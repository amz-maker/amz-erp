...
function Death(props: DeathProps) {
  /* ――――――――――――――― letiable ――――――――――――――― */
  /* ===== Props ===== */
  const { title } = props;
  ...
  const [text, setText] = React.useState<string>(`${days}`);
  ...
  React.useLayoutEffect(() => {
    ...
    let deadlineAnimation = function () {
      setTimeout(function () {
        setDuration(1.5);
      }, 0);
    ...
    function timer(totalTime: number, deadline: number) {
      let time = totalTime * 1000;
      let dayDuration = time / deadline;
      let actualDay = deadline;

      let timer = setInterval(countTime, dayDuration);

      function countTime() {
        --actualDay;
        setText(actualDay.toString());
      ...
      <div id="deadline">
        ...
        <div className="deadline-days">
          <div className="mask-red">
            <div className="inner">
              {title} <span className="day">{text}</span> <span className="days"></span>
            </div>
          </div>
